...
if [[ "$HYPERSCALER" == "google" ]]; then
    ...
    xdg-open "https://console.cloud.google.com/marketplace/product/google/container.googleapis.com?project=$PROJECT_ID"

    echo "## *ENABLE* the API" | gum format
    gum input --placeholder "Press the enter key to continue."

    xdg-open "https://console.cloud.google.com/apis/library/sqladmin.googleapis.com?project=$PROJECT_ID"
